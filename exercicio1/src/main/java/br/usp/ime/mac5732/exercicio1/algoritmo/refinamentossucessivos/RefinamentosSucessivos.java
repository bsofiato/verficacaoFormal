...
//			ro.printRo();
  ...
  public RefinamentosSucessivos(String jsonFile) throws Exception {
    this(lerJSON(jsonFile));
  }
...
//						ro.printRo();
  ...
  private static LTS lerJSON(String arquivo) throws Exception {
